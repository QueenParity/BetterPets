...
public class BetterWolfModel<T extends BetterWolfEntity> extends TintedAgeableModel<T>
{
    ...
    public void setLivingAnimations(T entity, float limbSwing, float limbSwingAmount, float partialTick)
    {
        ...
        this.headChild.rotateAngleZ = entity.getInterestedAngle(partialTick) + entity.getShakeAngle(partialTick, 0.0F);
        this.mane.rotateAngleZ = entity.getShakeAngle(partialTick, -0.08F);
        this.body.rotateAngleZ = entity.getShakeAngle(partialTick, -0.16F);
        this.tailChild.rotateAngleZ = entity.getShakeAngle(partialTick, -0.2F);
    }
