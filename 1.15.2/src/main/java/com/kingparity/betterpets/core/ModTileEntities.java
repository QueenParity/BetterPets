...
public class ModTileEntities
{
    ...
    public static final TileEntityType<WaterCollectorTileEntity> WATER_COLLECTOR = null;

    @ObjectHolder(TileEntityNames.WATER_FILTER)
    public static final TileEntityType<WaterFilterTileEntity> WATER_FILTER = null;
