package com.kingparity.betterpets.functions;

import com.google.gson.JsonDeserializationContext;
import com.google.gson.JsonObject;
import com.kingparity.betterpets.tileentity.IFluidTankWriter;
...
public class CopyFluidTanks extends LootFunction
{
    ...
    public static class Serializer extends LootFunction.Serializer<CopyFluidTanks>
    {
        public Serializer()
        {
            super(new ResourceLocation(Reference.ID, "copy_fluid_tanks"), CopyFluidTanks.class);
        }
