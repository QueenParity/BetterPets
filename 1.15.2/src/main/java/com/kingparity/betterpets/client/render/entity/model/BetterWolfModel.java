package com.kingparity.betterpets.client.render.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class BetterWolfModel<T extends BetterWolfEntity> extends TintedAgeableModel<T>
{
    ...
    public void setLivingAnimations(T entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        ...
        this.headChild.rotateAngleZ = entity.getInterestedAngle(partialTicks) + entity.getShakeAngle(partialTicks, 0.0F);
        this.mane.rotateAngleZ = entity.getShakeAngle(partialTicks, -0.08F);
        this.body.rotateAngleZ = entity.getShakeAngle(partialTicks, -0.16F);
        this.tailChild.rotateAngleZ = entity.getShakeAngle(partialTicks, -0.2F);
    }
