...
public class BetterWolfModel<T extends BetterWolf> extends ColorableAgeableListModel<T>
{
    ...
    public BetterWolfModel(ModelPart part)
    {
    ...
    public void prepareMobModel(T entity, float limbSwing, float limbSwingAmount, float partialTicks)
    {
        ...
        this.realHead.zRot = entity.getHeadRollAngle(partialTicks) + entity.getBodyRollAngle(partialTicks, 0.0F);
        this.upperBody.zRot = entity.getBodyRollAngle(partialTicks, -0.08F);
        this.body.zRot = entity.getBodyRollAngle(partialTicks, -0.16F);
        this.realTail.zRot = entity.getBodyRollAngle(partialTicks, -0.2F);
    }
