...
public class ModTileEntities
{
    ...
    /*
    WATER_COLLECTOR_OAK
    WATER_COLLECTOR_SPRUCE
    WATER_COLLECTOR_BIRCH
    WATER_COLLECTOR_JUNGLE
    WATER_COLLECTOR_ACACIA
    WATER_COLLECTOR_DARK_OAK
    WATER_COLLECTOR_STONE
    WATER_COLLECTOR_GRANITE
    WATER_COLLECTOR_DIORITE
    WATER_COLLECTOR_ANDESITE
    WATER_COLLECTOR_STRIPPED_OAK
    WATER_COLLECTOR_STRIPPED_SPRUCE
    WATER_COLLECTOR_STRIPPED_BIRCH
    WATER_COLLECTOR_STRIPPED_JUNGLE
    WATER_COLLECTOR_STRIPPED_ACACIA
    WATER_COLLECTOR_STRIPPED_DARK_OAK
