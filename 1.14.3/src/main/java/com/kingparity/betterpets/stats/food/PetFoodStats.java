package com.kingparity.betterpets.stats.food;
...
public class PetFoodStats
{
    ...
    {
        betterWolf.world.getPlayers().forEach((player) -> PacketHandler.sendTo(new MessageUpdateFoodStats(betterWolf.getEntityId(), this.foodLevel, this.foodSaturationLevel, this.foodExhaustionLevel), (ServerPlayerEntity)player));
