...
public class StorageInventory extends Inventory
{
    ...
    public StorageInventory(int slotCount, IStorage wrapper)
    {
        super(slotCount);
    ...
    public void openGui(ServerPlayerEntity player, BetterWolfEntity entity)
    {
        if(entity instanceof IStorage)
        {
            ...
            else
            {
                ...
                //PacketHandler.HANDLER.sendTo(new MessageStorageWindow(player.currentWindowId, entity.getEntityId()), player);
                PacketHandler.sendTo(new MessageStorageWindow(player.currentWindowId, entity.getEntityId()), player);
                player.openContainer = new StorageContainer(player.currentWindowId, player.inventory, this, entity);
