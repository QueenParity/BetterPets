...
{
    public static final String PET_CHEST = "pet_chest";
    public static final String PET_BIRTHDAY_HAT = "pet_birthday_hat";
    ...
    public static final String FILTERED_WATER_BUCKET = "filtered_water_bucket";
}